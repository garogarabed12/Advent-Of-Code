...
let splitCompartments (compartment: string) =
    let compartment1 = compartment.Substring(0, toSplit.Length / 2)
    let compartment2 = compartment.Substring(toSplit.Length / 2)
